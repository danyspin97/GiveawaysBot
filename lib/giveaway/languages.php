...
The hashtag has to be long between 5 and 32 characters.',
    'ValidHashtag_Msg' => 'The hashtag has to be long between 5 and 32 characters. Re-enter it.',
    ...
    'MaxPartecipants_Msg' => '<b>Max partecipants: </b>',
    'EnteringDescription_Msg' => 'Enter a description for the giveaway.',
    'MaxPartecipantNotValid_Msg' => 'The number of partecipants allowed is not valid. Please insert a new one.',
    ...
    'EnteringPrizeValue_Msg' => 'Enter how much this prize worth.',
    'Value_Msg' => '<b>Value :</b>',
